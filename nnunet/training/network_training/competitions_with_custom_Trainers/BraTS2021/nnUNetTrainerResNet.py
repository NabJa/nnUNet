...
from nnunet.network_architecture.resnet_segnet import UResSegNet
...
class nnUNetTrainerSegResNetEnc(nnUNetTrainerV2BraTSRegions):
    """
    SegNet trainer class. Implements training procedure using SegNet instead of generic UNet.
...
class nnUNetTrainerSegResNetDec(nnUNetTrainerV2BraTSRegions):
    """
    SegNet trainer class. Implements training procedure using SegNet instead of generic UNet.
