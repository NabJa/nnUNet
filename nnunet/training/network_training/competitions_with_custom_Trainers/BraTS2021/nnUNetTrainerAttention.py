...
from nnunet.network_architecture.performer_segnet import SegNetPerformer
...
class nnUNetTrainerSegNetMHSA(nnUNetTrainerV2BraTSRegions):
    """
    SegNet trainer class. Implements training procedure using SegNet instead of generic UNet.
...
class nnUNetTrainerSegNetMHCA(nnUNetTrainerV2BraTSRegions):
    """
    SegNet trainer class. Implements training procedure using SegNet instead of generic UNet.
...
class nnUNetTrainerSegNetTransformer(nnUNetTrainerV2BraTSRegions):
    """
    SegNet trainer class. Implements training procedure using SegNet instead of generic UNet.
